...
void recursiveMatTrans (
    ...
    if (n<=2) { // base case
        ...
        recursiveMatTrans ( global_n, n>>1, A, (n>>1) + offset_row_A,          offset_col_A,        B,          offset_row_B, (n>>1) + offset_col_B );
        recursiveMatTrans ( global_n, n>>1, A,          offset_row_A, (n>>1) + offset_col_A,        B, (n>>1) + offset_row_B,          offset_col_B );
        recursiveMatTrans ( global_n, n>>1, A, (n>>1) + offset_row_A, (n>>1) + offset_col_A,        B, (n>>1) + offset_row_B, (n>>1) + offset_col_B );
    }
}
...
int main(int argc, char* argv[])
{
    ...
    // FILE* matrix_a_fp = fopen("/home/velcro/Documents/Undergrad/CS/CompArch-211/2022_0s_221/pa5/matTrans/tests/matrix_a_8x8.txt", "r");
    if (!matrix_a_fp) {
        perror("fopen failed");
        return EXIT_FAILURE;
    }
